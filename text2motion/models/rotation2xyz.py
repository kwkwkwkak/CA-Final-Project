...
class Rotation2xyz:
    ...
    def __call__(self, x, mask, pose_rep, translation, glob,
        ...
        if mask is None:
            mask = torch.ones((x.shape[0], x.shape[2]), dtype=bool, device=x.device)
        ...
        nsamples, time, njoints = x_rotations.shape
        ...
        if not glob:
            ...
            global_orient = x_rotations[:, :, 0]
            rotations = x_rotations[:, :, 1:]
